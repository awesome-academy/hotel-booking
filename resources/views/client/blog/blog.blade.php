            ...
            <div class="row">
                <div class="col-lg-9 col-sm-8 blog-post-contents">
                    ...
                    <div class="blog-post"><!-- Blog Post -->
                        <h3><a href="{{ asset('') }}blog/{{ $post->id }}/detail">{{ $post->title }}</a></h3>
                        <div class="post-materials  clearfix">
                            <ul>
                                ...
                                <li><h6><a href="{{ asset('') }}blog/list/{{ $post->cate_id }}"><i class="fa fa-bars"></i>{{ $post->cate_name }}</a></h6></li>
                            </ul>
                        </div>
                        ...
                        <div class="button mini-button button-style-2 margint30"><h6><a href="{{ asset('') }}blog/{{ $post->id }}/detail">{{ __('messages.READ MORE') }}</a></h6></div>
                    </div>
                    @endforeach
                    @else
                        ...
                        <ul class="sidebar-recent">
                            ...
                            <li class="clearfix">
                                ...
                                <div class="pull-left blg-txt">
                                    <p>{{ $new->title }}<a class="active-color" href="{{ asset('') }}blog/{{ $new->id }}/detail">[...]</a></p>
                                </div>
                            </li>
                            @endforeach
                            @else
