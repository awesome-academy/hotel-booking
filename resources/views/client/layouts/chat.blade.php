<div id="body">
    ...
    <div class="chat-box">
        ...
        <div class="chat-box-email">
            <form>
                <input type="hidden" id="url-chat-with-admin-email-submit" value="{{ route('client.chatWithAdmin.submitEmail') }}">
                <div class="form-group">
                    <label class="my-label">{{ __('messages.Enter_Email') }}</label>
                    <input type="text" id="chat_with_admin_email" class="form-control" value="">
                </div>
                <div class="form-group">
                    <input type="submit" value="{{ __('messages.Submit') }}" class="form-control chat_with_admin_email_submit">
                </div>
            </form>
        </div>
        <div class="chat-box-holder">
            ...
            <div class="chat-input">
                <form>
                    ...
                    <button type="submit" class="chat-submit" id="chat-submit"><i class="fa fa-mail-forward">&nbsp;&nbsp;{{ __('messages.Send') }}</i>
                    </button>
                </form>
            </div>
        </div>
